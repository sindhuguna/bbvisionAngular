...
export class DesignationmasterService {
  ...
  save(save: any): Promise<any> {
    const url = environment.API_URL + 'designation_master/designation_insert.php';
    return this.http.post(url, save, this.httpOptions).toPromise();
  }

  view(): Promise<any> {
    const url = environment.API_URL + 'designation_master/designation_view.php';
    return this.http.post(url, this.httpOptions).toPromise();
  }

  update(update: any): Promise<any> {
    const url = environment.API_URL + 'designation_master/designation_update.php';
